...
- Build error `Sketch too big`: use partition scheme **Minimal SPIFFS (1.9MB APP with OTA/190KB SPIFFS)**. For CLI, compile/upload with `:PartitionScheme=min_spiffs` in `--fqbn`.
